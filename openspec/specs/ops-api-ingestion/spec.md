...
Define the internal Ops API requirements for operational data ingestion, including validated producer contracts, idempotent persistence, safe retry behavior, and operator-visible ingest health.
